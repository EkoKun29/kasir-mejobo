...
<body>
    <div class="ticket">
        <p class="centered"><b>TOKO MEJOBO</b>
            <br>
            <b>NOTA PENJUALAN CASH</b>
        </p>
        <p>
            <hr>
        ...
        <br>TOTAL: <b>@money($new_data->total)</b>
        <hr>
        <br>CASH: @money($new_data->bayar)
        <br>KEMBALIAN: @money($new_data->kembalian)
        <hr>
