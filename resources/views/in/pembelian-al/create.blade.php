    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createModalLabel">Form Pembelian Cash</h5>
            </div>
            <div class="modal-body">
                <form action="{{ route('pembelian-al.store') }}" method="post">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select id="select-supplier" name="nama_suplier" placeholder="Nama Supplier"
