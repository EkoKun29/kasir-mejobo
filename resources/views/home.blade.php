    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <a href="https://wa.me/6282325635815" class="btn btn-info btn-lg mb-2">Endang</a>

                <p><strong> 2. Untuk Pembelian Tele dan Pembelian Na harga di input per pcs</strong></p>
            </div>
        </div>
        <!-- <div class="row">
